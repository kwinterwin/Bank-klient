...
public class Admin_search_account extends javax.swing.JFrame {

    String [] accounts = new String[5];
    
    public Admin_search_account() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Поиск счета по паспортным данным");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            clientMessage = "searchAccount" + ","  + surname + "," + name + "," + lastname + "," + passport;
            ...
            if (mesParts[0].equals("success")) {
                ...
                jTable1.setModel(new AccountTable(message));
            }
            if (mesParts[0].equals("fail")) {
               jLabel6.setForeground(Color.red);
               jLabel6.setText("Пользователя не существует!");
            }
        } catch (Exception e) {
...
//            java.util.logging.Logger.getLogger(Admin_search_account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
